...
class builder_libssh2(builder_base):
    def __init__(self, env:environment.base):
        super().__init__("libssh2", env)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Build and install libssh2")
